use utf8;
package Asthma::Schema::Result::100ListUrl;
...
Asthma::Schema::Result::100ListUrl
...
=head1 TABLE: C<100_list_url>

=cut

__PACKAGE__->table("100_list_url");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4aNVjBthg25343+b/7K+RA
