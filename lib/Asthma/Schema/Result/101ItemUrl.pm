use utf8;
package Asthma::Schema::Result::101ItemUrl;
...
Asthma::Schema::Result::101ItemUrl
...
=head1 TABLE: C<101_item_url>

=cut

__PACKAGE__->table("101_item_url");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:UuiVW1XCT5we1n5CGAMkXQ
