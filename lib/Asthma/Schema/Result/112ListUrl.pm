use utf8;
package Asthma::Schema::Result::112ListUrl;
...
Asthma::Schema::Result::112ListUrl
...
=head1 TABLE: C<112_list_url>

=cut

__PACKAGE__->table("112_list_url");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PrKhewdr5PjzK3qRuH+6Zw
