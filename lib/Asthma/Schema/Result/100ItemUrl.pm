use utf8;
package Asthma::Schema::Result::100ItemUrl;
...
Asthma::Schema::Result::100ItemUrl
...
=head1 TABLE: C<100_item_url>

=cut

__PACKAGE__->table("100_item_url");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8vgFWi22+0pT4RgVXQItrg
